(() => {
    document.addEventListener("DOMContentLoaded", () => {
        ...
        if (!articleForm
            ...
            || !imageMaxSize
            || !imageLimitProgress) {
            console.error("Article edit form elements not found");
            return;
        }
        ...
        const editor = new Editor({
            ...
            placeholder: "Введите текст статьи в Markdown...",
